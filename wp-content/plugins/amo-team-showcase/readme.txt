...
== Upgrade Notice ==
Now the info panel will work if the site uses some "scroll-to" JS script / plugin or uses MagnificPopup.js (the latter should be fixed in most cases).<br>
IMPORTANT NOTICE: In previous version 1.1.2 HTML structure and some CSS class names of member thumbnails have been changed! If you wrote your custom CSS/JS for old HTML structure /CSS classes it may not work with this new versions of the plugin.