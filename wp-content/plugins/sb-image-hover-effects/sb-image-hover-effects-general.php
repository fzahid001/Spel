...
function sb_image_oxi_shortcode_function_general($styleid, $styledata, $listdata, $userdata) {
    ...
    foreach ($listdata as $value) {
        if ($value['stylename'] == 'sb-general-effects-1') {
            sb_image_oxi_shortcode_function_general1($styleid, $styledata, $value, $userdata);
        } elseif ($value['stylename'] == 'sb-general-effects-2') {
            sb_image_oxi_shortcode_function_general2($styleid, $styledata, $value, $userdata);
        } elseif ($value['stylename'] == 'sb-general-effects-3') {
            sb_image_oxi_shortcode_function_general3($styleid, $styledata, $value, $userdata);
        } elseif ($value['stylename'] == 'sb-general-effects-4') {
            sb_image_oxi_shortcode_function_general4($styleid, $styledata, $value, $userdata);
        } elseif ($value['stylename'] == 'sb-general-effects-5') {
            sb_image_oxi_shortcode_function_general5($styleid, $styledata, $value, $userdata);
        } elseif ($value['stylename'] == 'sb-general-effects-6') {
            sb_image_oxi_shortcode_function_general6($styleid, $styledata, $value, $userdata);
        } elseif ($value['stylename'] == 'sb-general-effects-7') {
            sb_image_oxi_shortcode_function_general7($styleid, $styledata, $value, $userdata);
        } elseif ($value['stylename'] == 'sb-general-effects-8') {
            sb_image_oxi_shortcode_function_general8($styleid, $styledata, $value, $userdata);
        } elseif ($value['stylename'] == 'sb-general-effects-9') {
            sb_image_oxi_shortcode_function_general9($styleid, $styledata, $value, $userdata);
        } elseif ($value['stylename'] == 'sb-general-effects-10') {
            sb_image_oxi_shortcode_function_general10($styleid, $styledata, $value, $userdata);
        } elseif ($value['stylename'] == 'sb-general-effects-11') {
            sb_image_oxi_shortcode_function_general11($styleid, $styledata, $value, $userdata);
        } elseif ($value['stylename'] == 'sb-general-effects-12') {
            sb_image_oxi_shortcode_function_general12($styleid, $styledata, $value, $userdata);
        } elseif ($value['stylename'] == 'sb-general-effects-13') {
            sb_image_oxi_shortcode_function_general13($styleid, $styledata, $value, $userdata);
        } elseif ($value['stylename'] == 'sb-general-effects-14') {
            sb_image_oxi_shortcode_function_general14($styleid, $styledata, $value, $userdata);
        } elseif ($value['stylename'] == 'sb-general-effects-15') {
            sb_image_oxi_shortcode_function_general15($styleid, $styledata, $value, $userdata);
        } 
    }
    ...
    <style>
        ...
        .sb-image-hover-<?php echo $styleid; ?> .sb-image-info, .sb-image-hover-<?php echo $styleid; ?> a .sb-image-info{
            border-radius: <?php echo $styledata[1]; ?>%;
            -moz-border-radius:  <?php echo $styledata[1]; ?>%;
            -webkit-border-radius:  <?php echo $styledata[1]; ?>%;
        }
...
function sb_image_admin_select_id($id) {
    ?>
...
function sb_image_oxi_shortcode_function_general1($styleid, $styledata, $value, $userdata) {
    ...
    if ($value['buttom_text'] != '') {
        $sbbuttontext = '<a ' . $opennewtab . ' href="' . $value['link'] . '" class="sb-image-button"> ' . sb_image_html_special_charecter($value['buttom_text']) . ' </a>';
    }
    ...
    if ($userdata == 'admindata') {
        sb_image_admin_select_id($value['id']);
    }
    ?>
    <style>
...
function sb_image_oxi_shortcode_function_general2($styleid, $styledata, $value, $userdata) {
    $listdatacss = $value['css'];
    $listdatacss = explode('|', $listdatacss);
    $sbtitle = '';
    $sbdesc = '';
...
function sb_image_oxi_shortcode_function_general3($styleid, $styledata, $value, $userdata) {
    $listdatacss = $value['css'];
    $listdatacss = explode('|', $listdatacss);
    $sbtitle = '';
    $sbdesc = '';
...
function sb_image_oxi_shortcode_function_general4($styleid, $styledata, $value, $userdata) {
    $listdatacss = $value['css'];
    $listdatacss = explode('|', $listdatacss);
    $sbtitle = '';
    $sbdesc = '';
...
function sb_image_oxi_shortcode_function_general5($styleid, $styledata, $value, $userdata) {
    $listdatacss = $value['css'];
    $listdatacss = explode('|', $listdatacss);
    $sbtitle = '';
    $sbdesc = '';
...
function sb_image_oxi_shortcode_function_general6($styleid, $styledata, $value, $userdata) {
    $listdatacss = $value['css'];
    $listdatacss = explode('|', $listdatacss);
    $sbtitle = '';
    $sbdesc = '';
...
function sb_image_oxi_shortcode_function_general7($styleid, $styledata, $value, $userdata) {
    $listdatacss = $value['css'];
    $listdatacss = explode('|', $listdatacss);
    $sbtitle = '';
    $sbdesc = '';
...
function sb_image_oxi_shortcode_function_general8($styleid, $styledata, $value, $userdata) {
    $listdatacss = $value['css'];
    $listdatacss = explode('|', $listdatacss);
    $sbtitle = '';
    $sbdesc = '';
...
function sb_image_oxi_shortcode_function_general9($styleid, $styledata, $value, $userdata) {
    $listdatacss = $value['css'];
    $listdatacss = explode('|', $listdatacss);
    $sbtitle = '';
    $sbdesc = '';
...
function sb_image_oxi_shortcode_function_general10($styleid, $styledata, $value, $userdata) {
    $listdatacss = $value['css'];
    $listdatacss = explode('|', $listdatacss);
    $sbtitle = '';
    $sbdesc = '';
...
function sb_image_oxi_shortcode_function_general11($styleid, $styledata, $value, $userdata) {
    $listdatacss = $value['css'];
    $listdatacss = explode('|', $listdatacss);
    $sbtitle = '';
    $sbdesc = '';
...
function sb_image_oxi_shortcode_function_general12($styleid, $styledata, $value, $userdata) {
    $listdatacss = $value['css'];
    $listdatacss = explode('|', $listdatacss);
    $sbtitle = '';
    $sbdesc = '';
...
function sb_image_oxi_shortcode_function_general13($styleid, $styledata, $value, $userdata) {
    $listdatacss = $value['css'];
    $listdatacss = explode('|', $listdatacss);
    $sbtitle = '';
    $sbdesc = '';
...
function sb_image_oxi_shortcode_function_general14($styleid, $styledata, $value, $userdata) {
    $listdatacss = $value['css'];
    $listdatacss = explode('|', $listdatacss);
    $sbtitle = '';
    $sbdesc = '';
...
function sb_image_oxi_shortcode_function_general15($styleid, $styledata, $value, $userdata) {
    $listdatacss = $value['css'];
    $listdatacss = explode('|', $listdatacss);
    $sbtitle = '';
    $sbdesc = '';
